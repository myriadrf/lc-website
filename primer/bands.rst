...
LTE frequency bands are identified by a number. For example, LTE Band 3 corresponds to the 1800 MHz band. Why not just state the frequency? LTE Band 3 denotes more than simply the frequency range and 3GPP specs state that this is to be used with frequency division duplex (FDD) operation, with downlink to the UE on 1805-1880 MHz and uplink from it on 1710-1785 MHz. They furthermore state that valid channel bandwidths for LTE Band 3 are 1.4, 3, 5, 10, 15 and 20 MHz. 
